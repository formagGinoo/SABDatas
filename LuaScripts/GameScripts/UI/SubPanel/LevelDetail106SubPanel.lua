...
local LevelDetail106SubPanel = class("LevelDetail106SubPanel", UISubPanelBase)
local EnterAnimStr = "Dalcaro_dialoguedetial_in"
local OutAnimStr = "Dalcaro_dialoguedetial_out"

function LevelDetail106SubPanel:OnBtnbuffheroClicked()
...
function LevelDetail106SubPanel:OnBtnchallengebuffheroClicked()
  if not self.m_activityID then
    return
  end
...
function LevelDetail106SubPanel:OnBtnquickClicked()
...
function LevelDetail106SubPanel:CheckShowAnimOut(endFun)

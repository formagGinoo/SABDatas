...
local LevelDetail112SubPanel = class("LevelDetail112SubPanel", UISubPanelBase)
local EnterAnimStr = "Dalcaro_dialoguedetial_in"
local OutAnimStr = "Dalcaro_dialoguedetial_out"

function LevelDetail112SubPanel:OnBtnbuffheroClicked()
...
function LevelDetail112SubPanel:OnBtnchallengebuffheroClicked()
  if not self.m_activityID then
    return
  end
...
function LevelDetail112SubPanel:OnBtnquickClicked()
...
function LevelDetail112SubPanel:CheckShowAnimOut(endFun)

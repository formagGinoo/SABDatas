...
local LevelDetail109SubPanel = class("LevelDetail109SubPanel", UISubPanelBase)
local OutAnimStr = "Dalcaro_dialoguedetial_out"

function LevelDetail109SubPanel:OnBtnbuffheroClicked()
...
function LevelDetail109SubPanel:OnBtnchallengebuffheroClicked()
  if not self.m_activityID then
    return
  end
...
function LevelDetail109SubPanel:OnBtnquickClicked()
...
function LevelDetail109SubPanel:CheckShowAnimOut(endFun)

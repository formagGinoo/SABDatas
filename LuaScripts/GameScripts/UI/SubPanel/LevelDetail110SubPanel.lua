...
local LevelDetail110SubPanel = class("LevelDetail110SubPanel", UISubPanelBase)
local EnterAnimStr = "Dalcaro_dialoguedetial_in"
local OutAnimStr = "Dalcaro_dialoguedetial_out"

function LevelDetail110SubPanel:OnBtnbuffheroClicked()
...
function LevelDetail110SubPanel:OnBtnchallengebuffheroClicked()
  if not self.m_activityID then
    return
  end
...
function LevelDetail110SubPanel:OnBtnquickClicked()
...
function LevelDetail110SubPanel:CheckShowAnimOut(endFun)

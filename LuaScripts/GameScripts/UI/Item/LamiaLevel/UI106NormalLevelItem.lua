...
function UI106NormalLevelItem:OnInit()
...
function UI106NormalLevelItem:OnFreshData()
...
function UI106NormalLevelItem:FreshItemUI()
...
function UI106NormalLevelItem:ChangeChoose(isChoose)
...
function UI106NormalLevelItem:OnBtnItemClk()
...
function UI106NormalLevelItem:GetCostItemNameStr()
...
function UI106NormalLevelItem:OnBtnRepeatClk()
  if not self.m_itemData then
    return
  end
  if not self.m_isUnlock then
...
function UI106NormalLevelItem:IsHaveEnoughTimes()
  local itemNum = self:GetCostItemNum() or 0
  return 0 < itemNum, itemNum
end

function UI106NormalLevelItem:GetCostItemNum()

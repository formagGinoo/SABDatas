local Form_ActivityParty12 = class("Form_ActivityParty12", require("UI/UIFrames/Form_ActivityParty12UI"))

function Form_ActivityParty12:SetInitParam(param)
end

function Form_ActivityParty12:AfterInit()
...
function Form_ActivityParty12:OnActive()
  self.super.OnActive(self)
  self.m_stActivity = self.m_csui.m_param.m_stActivity
  self:RefreshUI()
end

function Form_ActivityParty12:OnUncoverd()
  self:RefreshUI()
end

function Form_ActivityParty12:OnInactive()
  self.super.OnInactive(self)
  PushFaceManager:CheckShowNextPopPanel()
end

function Form_ActivityParty12:OnDestroy()
  self.super.OnDestroy(self)
end

function Form_ActivityParty12:RefreshUI()
...
function Form_ActivityParty12:OnBtntouchClicked()
  self:OnClickJump2System(1)
end

function Form_ActivityParty12:OnBtntouch02Clicked()
  self:OnClickJump2System(2)
end

function Form_ActivityParty12:OnBtntouch03Clicked()
  self:OnClickJump2System(3)
end

function Form_ActivityParty12:OnBtntouch04Clicked()
  self:OnClickJump2System(4)
end

function Form_ActivityParty12:OnBtntouch05Clicked()
  self:OnClickJump2System(5)
end

function Form_ActivityParty12:OnBtntouch06Clicked()
  local cfg = self.m_stActivity:GetWelfareCfg()
  local mSystemList = cfg.vSystem
...
function Form_ActivityParty12:OnBtntouch07Clicked()
  self:OnClickJump2System(7)
end

function Form_ActivityParty12:OnBtntouch08Clicked()
  self:OnClickJump2System(8)
end

function Form_ActivityParty12:OnClickJump2System(idx)
...
function Form_ActivityParty12:OnBackClk()
  self:CloseForm()
end

function Form_ActivityParty12:IsOpenGuassianBlur()
  return true
end

local fullscreen = true
ActiveLuaUI("Form_ActivityParty12", Form_ActivityParty12)
